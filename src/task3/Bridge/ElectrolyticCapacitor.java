...
public class ElectrolyticCapacitor extends StandardCapacitor implements Capacitor {
    ...
    public ElectrolyticCapacitor(double capacitance, double voltage, double maximumVoltage, Manufacturer manufacturer) {
        super(capacitance, voltage, manufacturer);
    ...
    public ElectrolyticCapacitor deepCopy() {
        return new ElectrolyticCapacitor(this.capacitance, this.voltage, this.maximumVoltage, this.manufacturer);
    }
