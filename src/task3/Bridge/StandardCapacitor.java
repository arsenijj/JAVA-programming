...
public class StandardCapacitor extends AbstractElectronicComponent implements Comparable<StandardCapacitor>, Capacitor {
    ...
    public StandardCapacitor(double capacitance, double voltage, Manufacturer manufacturer) {
        super(manufacturer);
    ...
    public StandardCapacitor deepCopy() {
        return new StandardCapacitor(this.capacitance, this.voltage, this.manufacturer);
    }
