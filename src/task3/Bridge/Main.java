...
public class Main {
    ...
    public void run() {
        ...
        // StandardCapacitor
        StandardCapacitor standardCapacitor1 = new StandardCapacitor(12.22, 14.44, new EnergetikaManufacturer());
        StandardCapacitor standardCapacitor2 = new StandardCapacitor(12.22, 14.44, new ProgressManufacturer());
        ...
        System.out.println(standardCapacitor1.manufacturer.getManufacturer());
        System.out.println(standardCapacitor2.manufacturer.getManufacturer());
        System.out.println(electrolyticCapacitor1.manufacturer.getManufacturer());
        System.out.println(electrolyticCapacitor2.manufacturer.getManufacturer());
        System.out.println(standardCapacitor1DeepCopy.manufacturer.getManufacturer());
        System.out.println(electrolyticCapacitor1DeepCopy.manufacturer.getManufacturer());
    }
